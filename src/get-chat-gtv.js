// TODO : button to load script
const source = "gtv"
const targetEM = '#room-messages';  // mutation observer  // element where messages get added
const messageEM = ".user-message";  // added EM
const cashEM = "TODO"  // cash chat EM
const authorEM = ".message-username span" // username EM
const textEM = ".message-text span" //
